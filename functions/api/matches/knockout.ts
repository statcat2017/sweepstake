...
export async function onRequest(context: { request: Request; env: { DB: D1Database } }): Promise<Response> {
  try {
    ...
    const knockoutMatches = [
      { stage: "round_of_16", match: "W37", home: q["A"]?.[1] ?? 0, away: q["C"]?.[2] ?? 0, home_label: "1A", away_label: "2C" },
      { stage: "round_of_16", match: "W38", home: q["C"]?.[1] ?? 0, away: q["A"]?.[2] ?? 0, home_label: "1C", away_label: "2A" },
      { stage: "round_of_16", match: "W39", home: q["B"]?.[1] ?? 0, away: q["D"]?.[2] ?? 0, home_label: "1B", away_label: "2D" },
      { stage: "round_of_16", match: "W40", home: q["D"]?.[1] ?? 0, away: q["B"]?.[2] ?? 0, home_label: "1D", away_label: "2B" },
      { stage: "round_of_16", match: "W41", home: q["E"]?.[1] ?? 0, away: t[0]?.team_id ?? 0, home_label: "1E", away_label: "3rd #1" },
      { stage: "round_of_16", match: "W42", home: t[1]?.team_id ?? 0, away: q["F"]?.[1] ?? 0, home_label: "3rd #2", away_label: "1F" },
      { stage: "round_of_16", match: "W43", home: q["F"]?.[2] ?? 0, away: q["E"]?.[2] ?? 0, home_label: "2F", away_label: "2E" },
      { stage: "round_of_16", match: "W44", home: q["H"]?.[1] ?? 0, away: q["G"]?.[2] ?? 0, home_label: "1H", away_label: "2G" },
      { stage: "round_of_16", match: "W45", home: q["G"]?.[1] ?? 0, away: q["H"]?.[2] ?? 0, home_label: "1G", away_label: "2H" },
      { stage: "round_of_16", match: "W46", home: q["J"]?.[1] ?? 0, away: t[2]?.team_id ?? 0, home_label: "1J", away_label: "3rd #3" },
      { stage: "round_of_16", match: "W47", home: t[3]?.team_id ?? 0, away: q["I"]?.[1] ?? 0, home_label: "3rd #4", away_label: "1I" },
      { stage: "round_of_16", match: "W48", home: q["I"]?.[2] ?? 0, away: q["J"]?.[2] ?? 0, home_label: "2I", away_label: "2J" },
